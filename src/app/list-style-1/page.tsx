            ...
            <div className="container">
                <div className="row">
                    <div className="col-lg-12 col-md-12">
                        <h2 className="ipt-title">List style 01</h2>
                        <div className="breadcrumbs light">
                            <nav aria-label="breadcrumb">
                                <ol className="breadcrumb">
                                    <li className="breadcrumb-item"><Link href="#">Home</Link></li>
                                    <li className="breadcrumb-item"><Link href="#">NRI Client</Link></li>
                                    <li className="breadcrumb-item active" aria-current="page">Service list 01</li>
                                </ol>
                            </nav>
                        </div>
                    </div>
                                ...
                                <div className="light-jbs-alert mb-3">
                                    <div className="row justify-content-center g-3">
                                        ...
                                        <div className="col-xl-3 col-lg-4 col-md-4">
                                            <div className="form-group m-0">
                                                <button type="button" className="btn btn-main fs-6 fw-medium full-width">Save Alert!</button>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div className="jbs-list-box border">
                                        <div className="jbs-list-head">
                                            <div className="jbs-list-head-thunner">
                                                <div className="jbs-list-emp-thumb jbs-verified"><Link href={`/service-detail/${item.id}`}><figure><Image src={item.image} className="img-fluid" width={50} height={50} alt=""/></figure></Link></div>
                                        ...
                                        <div className="jbs-list-caption">
                                            <div className="jbs-info-ico-style">
                                                ...
                                                <div className="jbs-single-y1 style-2"><span><i className="fa-solid fa-clock"></i></span>{serviceEngagementLabel(item.jobtype)}</div>
                                                <div className="jbs-single-y1 style-3"><span><i className="fa-solid fa-coins"></i></span>Guided workflow</div>
                                            </div>
                                        </div>
                                    </div>
                                </div>
