                            ...
                            <div className="detail-side-middle">
                                ...
                                <div className="form-group">
                                    ...
                                    <div className="form-check form-check-inline">
                                        <input className="form-check-input" type="radio" name="nrioci" id="wyes" value="option1"/>
                                        <label className="form-check-label" htmlFor="wyes">Yes</label>
                                    </div>
                                    <div className="form-check form-check-inline">
                                        <input className="form-check-input" type="radio" name="nrioci" id="wno" value="option1"/>
                                ...
                                <div className="form-group">
                                    ...
                                    <div className="form-check form-check-inline">
                                        <input className="form-check-input" type="radio" name="repindia" id="dyed" value="option1"/>
                                        <label className="form-check-label" htmlFor="dyed">Yes</label>
                                    </div>
                                    <div className="form-check form-check-inline">
                                        <input className="form-check-input" type="radio" name="repindia" id="dno" value="option1"/>
                                        <label className="form-check-label" htmlFor="dno">No</label>
                                    </div>
                                </div>
                                <div className="form-group">
                                    <div className="form-check form-check-inline">
                                        <input className="form-check-input" type="checkbox" id="service-alert-side" value="option1"/>
                                        <label className="form-check-label" htmlFor="service-alert-side">Notify me about related services</label>
                                    </div>
                                </div>
                                <div className="form-group">
                ...
                <div className="modal-content" id="applyServiceContent">
                    ...
                    <div className="modal-body">
                        <div className="detail-side-heads mb-4 mt-4">
                            <h3 id="applyServiceHeading">Ready to get started?</h3>
                            <p>Share a few details so we can confirm scope and assign the right specialist.</p>
                        </div>
                        <div className="detail-side-middle">
                            <div className="form-floating mb-3">
                            ...
                            <div className="form-group">
                                <div className="elsoci"><label>Are you an NRI or OCI seeking India-related support?</label></div>
                                <div className="form-check form-check-inline">
                                    <input className="form-check-input" type="radio" name="nrioci-modal" id="mwyes" value="option1"/>
                                    <label className="form-check-label" htmlFor="mwyes">Yes</label>
                                </div>
                                <div className="form-check form-check-inline">
                                    <input className="form-check-input" type="radio" name="nrioci-modal" id="mwno" value="option1"/>
                                    <label className="form-check-label" htmlFor="mwno">No</label>
                                </div>
                            </div>
                            <div className="form-group">
                                <div className="elsoci"><label>Do you need a representative to act in India on your behalf?</label></div>
                                <div className="form-check form-check-inline">
                                    <input className="form-check-input" type="radio" name="repindia-modal" id="mdyed" value="option1"/>
                                    <label className="form-check-label" htmlFor="mdyed">Yes</label>
                                </div>
                                <div className="form-check form-check-inline">
                                    <input className="form-check-input" type="radio" name="repindia-modal" id="mdno" value="option1"/>
                                    <label className="form-check-label" htmlFor="mdno">No</label>
                                </div>
                            </div>
                            <div className="form-group">
                                <div className="form-check form-check-inline">
                                    <input className="form-check-input" type="checkbox" id="service-alert-modal" value="option1"/>
                                    <label className="form-check-label" htmlFor="service-alert-modal">Notify me about related services</label>
                                </div>
                            </div>
                            <div className="form-group">
                                <button type="button" className="btn btn-main full-width fw-medium font-sm">Submit request</button>
