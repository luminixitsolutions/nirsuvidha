...
import { footerTagline, siteName, copyrightLine } from '../../data/site-content'
                    ...
                    <div className="row">
                        ...
                        <div className="col-lg-3 col-md-4">
                            <div className="footer-widget">
                                <div className="footer-add mb-3">
                                    <h5 className="text-main text-uppercase fw-bold mb-2">{siteName}</h5>
                                    <p className="text-light opacity-90 small">{footerTagline}</p>
                                </div>
                                <div className="foot-socials">
                                    <ul>
                                        {footerSocial.map((item:string, index:number)=>( 
                        ...
                        <div className="col-lg-2 col-md-4">
                            <div className="footer-widget">
                                <h4 className="widget-title">For NRIs</h4>
                                <ul className="footer-menu">
                                    {footerLink1.map((item:string,index:number)=>( 
                        ...
                        <div className="col-lg-2 col-md-4">
                            <div className="footer-widget">
                                ...
                                <ul className="footer-menu">
                                    {footerLink2.map((item:string,index:number)=>( 
                                        <li key={index}><Link href="#">{item}</Link></li>
                                    ))}
                                </ul>
                            </div>
                        ...
                        <div className="col-lg-2 col-md-6">
                            <div className="footer-widget">
                                ...
                                <ul className="footer-menu">
                                    {footerLink3.map((item:string,index:number)=>( 
                                        <li key={index}><Link href="#">{item}</Link></li>
                                    ))}
                                </ul>
                            </div>
                ...
                <div className="container">
                    <div className="row align-items-center justify-content-between">
                        ...
                        <div className="col-xl-4 col-lg-5 col-md-5">
                            <p className="mb-0">{copyrightLine(new Date().getFullYear())}</p>
                        </div>
                        
                        <div className="col-xl-8 col-lg-7 col-md-7">
                            <div className="job-info-count-group">
                                {footerCounter.map((item:Counter,index:number)=>( 
