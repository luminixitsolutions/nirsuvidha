...
@extends('admin.layouts.shell', ['title' => 'Add partner onboarding — NRI Suvidha Admin'])
...
<div class="card-form form">
    <h1>Add partner onboarding</h1>
    <p class="muted" style="margin:-0.35rem 0 1rem;">Enter the same details as the public form. Upload professional license and signed agreement (required).</p>
    ...
    <form method="post" action="{{ route('admin.partner_onboardings.store') }}" enctype="multipart/form-data">
        @csrf
        ...
        <h2 class="sec-title">Professional documents</h2>
        <div class="field"><label for="profile_photo">Profile Photo</label>
            <input id="profile_photo" name="profile_photo" type="file" accept=".jpg,.jpeg,.png,image/jpeg,image/png" />
            <p class="muted" style="margin:0.25rem 0 0;font-size:0.8rem;">Professional headshot (optional)</p></div>
        <div class="field"><label for="license">Professional License *</label>
            <input id="license" name="license" type="file" accept=".pdf,.jpg,.jpeg,.png,application/pdf,image/*" required />
            <p class="muted" style="margin:0.25rem 0 0;font-size:0.8rem;">Bar/ICAI/RERA certificate</p></div>
        <div class="field"><label for="partner_agreement">Partner Agreement *</label>
            <input id="partner_agreement" name="partner_agreement" type="file" accept=".pdf,application/pdf" required />
            <p class="muted" style="margin:0.25rem 0 0;font-size:0.8rem;">Signed partner agreement</p></div>
        ...
        <div style="display:flex;gap:0.75rem;margin-top:1.25rem;flex-wrap:wrap;">
            <button type="submit" class="btn-gold">Save partner</button>
