@extends('admin.layouts.shell', ['title' => 'Employees — NRI Suvidha Admin'])
...
<div class="toolbar">
    <h1>Employees</h1>
    <a class="btn-sm" href="{{ route('admin.employees.create') }}">Add employee</a>
</div>
    ...
    <table>
        ...
        <tbody>
            ...
            <tr>
                ...
                <td class="muted">{{ $e->designation?->name ?: '—' }}</td>
                <td>
                    @if($e->is_active)
                ...
                <td>
                    <div class="actions">
                        <a href="{{ route('admin.employees.edit', $e) }}">Edit</a>
                        <form method="post" action="{{ route('admin.employees.destroy', $e) }}" style="display:inline;" onsubmit="return confirm('Delete this employee?');">
                            @csrf
                            @method('DELETE')
            ...
            @empty
            <tr>
                <td colspan="6" class="muted" style="padding:1.5rem;">No employees yet.</td>
            </tr>
            @endforelse
        </tbody>
    </table>
